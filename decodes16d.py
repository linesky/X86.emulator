...
registers = ["ax", "bx", "cx","dx", "si", "di","sp","si","di","[ax]", "[bx]", "[cx]","[dx]", "[si]", "[di]","[sp]","[si]","[di]"]
...
def generate_assembly_and_test(instruction, register):
...
for instruction in instructions:
    for register in registers:
        ...
        generate_assembly_and_test(instruction, register)
